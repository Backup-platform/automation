...
export class Promotions {
	...
	private readonly cardCount = () => this.page.locator('#promotions-container >div');
	...
	private readonly cardContent = (cardNumber: string) => this.page.locator('#promotion-card-' + cardNumber + '-content');
