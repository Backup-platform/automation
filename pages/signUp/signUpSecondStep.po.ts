...
import { Navigation, step, stepParam, assertAttribute, clickElement,assertVisible, fillInputField, assertEditable, assertEnabled, assertNotEnabled  } from '../utils/navigation.po';
...
export class SignUpSecondStep {
    ...
    public validateFirstNameVisible = async (softAssert = false) =>
        await assertVisible(this.firstName(), softAssert, 'First name field');
    ...
    public validateLastNameVisible = async (softAssert = false) =>
        await assertVisible(this.lastName(), softAssert, 'Last name field');
    ...
    public validateDOBVisible = async (softAssert = false) =>
        await assertVisible(this.dateOfBirthTextArea(), softAssert, 'Date of birth field');
    ...
    public validateLastNameEditable = async (softAssert = false) =>
        await assertEditable(this.lastName(), softAssert, 'Last name field');

    public validateFirstNameEditable = async (softAssert = false) =>
        await assertEditable(this.firstName(), softAssert, 'First name field');

    public validateDOBEditable = async (softAssert = false) =>
        await assertEditable(this.dateOfBirthTextArea(), softAssert, 'Date of birth field');

    public validateGenderButtonVisible = async (softAssert = false) =>
        await assertVisible(this.genderButton(), softAssert, 'Gender button');

    public validateGenderContainerVisible = async (softAssert = false) =>
        await assertVisible(this.genderOptionsContainer(), softAssert, 'Gender container');
    
    public validateAlmostDoneButtonVisible = async (softAssert = false) =>
        await assertVisible(this.almostDoneButton(), softAssert, 'Almost done button');

    public validateAlmostDoneButtonEnabled = async (softAssert = false) =>
        await assertEnabled(this.almostDoneButton(), softAssert, 'Almost Done button');

    public validateAlmostDoneNotEnabled = async (softAssert = false) =>
        await assertNotEnabled(this.almostDoneButton(), softAssert, 'Almost Done button');
