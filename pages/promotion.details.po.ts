...
export class PromotionDetails {
	...
	//Locators
	private readonly promoBannerCardContainer = () => this.page.locator('div[class*="promoPage_promoPageDesktopHeader"]');
	...
	public async validateCardElementsMobileContent(title: string, subtitle: string, buttonText: string) {
		await test.step('Validate promotion card elemetns', async () => {
