...
import { step, performNavigationClick, assertVisible, assertNotVisible, validateAttributes, assertAttribute , clickElement, assertUrl, assertUrlContains } from '@test-utils/navigation.po';
...
export class HeaderMenuDesktop {
	...
	public validateSFLogoImageVisible = async () =>
	...
	public validateVIPButtonVisible = async () => await assertAttribute(this.vipButton(), 'href', 'VIP Button', true, "/vip");

	public validateLoyaltyButtonVisible = async () => await assertAttribute(this.loyaltyButton(), 'href', 'Loyalty Button', true, "/loyalty");
